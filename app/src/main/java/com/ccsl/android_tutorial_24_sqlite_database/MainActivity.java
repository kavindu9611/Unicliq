...
Button studentresult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toDos = new ArrayList<>();
        studentresult = findViewById(R.id.button4);
        ...
        count.setText("You have "+countTodo+" time tables");
        ...
        studentresult.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(context,ProfileManagement.class));
            }
        });
