...
public class EditToDo extends AppCompatActivity {
    ...
    private EditText title,venue,des;
    private Button edit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        venue = findViewById(R.id.editTextupdateVenue);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ToDo toDo = new ToDo(Integer.parseInt(id),titleText,venueText,decText,updateDate,0);
